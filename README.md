...
* [Java 8 notes](#java-8-notes)
  ...
  * [Streams](#streams)
     * [Stream properties](#stream-properties)
        * [Traversable only once](#traversable-only-once)
     ...
     * [Stream operations](#stream-operations)
        ...
        * [Finding and matching](#finding-and-matching)
           * [If a predicate matches at least one element](#if-a-predicate-matches-at-least-one-element)
           * [If a predicate matches all elements](#if-a-predicate-matches-all-elements)
           * [noneMatch](#nonematch)
